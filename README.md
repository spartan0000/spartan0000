...
I don't build healthcare tools in a vacuum. I *do* the work. I know which admin tasks waste time, which workflows are broken, which problems are actually worth solving. Every tool I build solves a problem I personally experience.
